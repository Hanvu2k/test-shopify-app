...
|----|------|--------|--------|----------|-----------|
| 4.1 | {Task name} | {pts} | | {Role} | {-.md} |
| 4.2 | {Task name} | {pts} | | {Role} | {-.md} |
...
|------------|--------|--------|
| Task 4.X → {M}.Y | {Why dependency exists} | Resolved / Pending |
