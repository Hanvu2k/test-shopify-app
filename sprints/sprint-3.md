...
|----|------|--------|--------|----------|-----------|
| 3.1 | {Task name} | {pts} | | {Role} | {-.md} |
| 3.2 | {Task name} | {pts} | | {Role} | {-.md} |
...
|------------|--------|--------|
| Task 3.X → {M}.Y | {Why dependency exists} | Resolved / Pending |
