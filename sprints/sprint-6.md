...
|----|------|--------|--------|----------|-----------|
| 6.1 | {Task name} | {pts} | | {Role} | {-.md} |
| 6.2 | {Task name} | {pts} | | {Role} | {-.md} |
...
|------------|--------|--------|
| Task 6.X → {M}.Y | {Why dependency exists} | Resolved / Pending |
